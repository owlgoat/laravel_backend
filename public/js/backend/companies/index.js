$(function () {
    ...
    $("#datalist").tabulator({
        ...
        columns: [
            ...
            {title: "Prefecture", field: "prefecture_id", width: 130, headerFilter: "select", headerFilterParams: getPrefuctures, headerFilterPlaceholder: " "},
