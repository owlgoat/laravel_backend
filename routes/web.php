...
Route::GROUP(['middleware' => ['auth:user']], function() {
    ...
    Route::GET('/companies/add', 'Backend\CompanyController@add')->name('companies.add');
    Route::get('/postcode/{postcode}/address', 'Backend\CompanyController@getAddressByPostcode');
    Route::POST('/companies/create', 'Backend\CompanyController@create')->name('companies.create');
    Route::GET('/companies/edit/{id}', 'Backend\CompanyController@edit')->name('companies.edit');
    Route::POST('/companies/update', 'Backend\CompanyController@update')->name('companies.update');
    Route::GET('/companies/delete', 'Backend\CompanyController@delete')->name('companies.delete');
});